...
import { Mail, Lock, LogIn, AlertCircle, Eye, EyeOff, ShoppingBag, ShieldCheck, Award } from 'lucide-react';
...
export default function Login() {
  ...
  const validateInput = (emailVal, passVal) => {
    const errs = [];
  ...
  const handleGoogleLoginSelect = async (name, googleEmail) => {
    setShowGoogleModal(false);
    setLoading(true);
    setError('');

    const mockSub = "google-sub-" + googleEmail.split('@')[0];
    const mockIdToken = `mock_google_token_${googleEmail}_${name.replace(/\s+/g, '-')}_${mockSub}`;
    
    const result = await loginWithGoogle(mockIdToken, googleEmail, name, mockSub);
    setLoading(false);
      ...
      <div className="w-full md:w-[55%] bg-[#0A0A0C] min-h-[500px] md:min-h-screen flex items-center justify-center p-6 sm:p-10 md:p-16 relative">
        ...
        <div className="w-full max-w-[400px] space-y-6 z-10">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-gray-400">Sign in to continue to Bazaario</p>
          </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-end pt-1">
                <button
                  ...
                  className="text-[10px] text-bazaario-primary hover:underline font-bold transition-all"
                >
                  Forgot Password?
                </button>
              </div>
          ...
          <p className="text-center text-xs text-gray-500">
            ...
            <RouterLink to="/register" className="text-bazaario-primary hover:underline font-bold transition-all">
              Sign Up
            </RouterLink>
          </p>
        </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/85 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-[#13131A] border border-bazaario-border p-8 rounded-2xl w-full max-w-sm space-y-6 shadow-2xl relative">
            <div className="text-center space-y-2">
              ...
              <h3 className="font-extrabold text-base tracking-tight text-white pt-2">Sign in with Google</h3>
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-gray-400 max-w-xs mx-auto">
                Please wait a moment while we securely authenticate your account and prepare your personalized experience.
              </p>
            </div>
          </div>
        </div>
